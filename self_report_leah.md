...
I had no problems with the implementations itself. However, understanding why tests failed is always a challenge.
A challenge I encountered was working together as a team *correctly* with GitHub. I have failed to properly get my teammates on board. GitHub was used throughout, but not as it is designed for. There I see that I should have done a better job teaching the principles of GitHub in the very beginning.
